...
export default function GroupBox({ group, setGroupSelected, messages }) {
    ...
    // }
    return (
        <div className="contact-box" onClick={() => setGroupSelected(group.name)}>
            <Avatar group={group} />
            <div className="right-section">
                <div className="contact-box-header">
                    <h3 className="avatar-title">{group.name}</h3>
